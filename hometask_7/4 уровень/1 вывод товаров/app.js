...
function showCategory(category) {
    let categoryGoods = products[category];
    let goodsMarkup = '';
    categoryGoods.forEach((product) => {
        goodsMarkup = goodsMarkup + getProductMarkup(product);
    });
    productsElems.insertAdjacentHTML("afterbegin", goodsMarkup);
}
...
function getProductMarkup(product) {
    return `
        <div class="product">
            ...
            <img src="${product.imageUrl}" alt="Фото клевого товара">
